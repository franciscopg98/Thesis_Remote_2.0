"""
Django settings for tese project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'dbtese.sqlite3'),
    }
}
...
S1_Query_MODEL = 'S_1.Query'
S2_Query_MODEL = 'S_2.Query'
S5P_Query_MODEL = 'S_5P.Query'
...
KEY = {"S_1": S1QueryForm, "S_2": S2QueryForm, "S_5P": S5PQueryForm}